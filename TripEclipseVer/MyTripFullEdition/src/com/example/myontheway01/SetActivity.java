		...
		if (isChecked) {
			...
			mUser.update(this,bmobUser.getObjectId(),new UpdateListener() {
			    ...
			    public void onFailure(int code, String msg) {
			       Toast.makeText(SetActivity.this, "修改失败", Toast.LENGTH_LONG).show();
			    }
			});
		} else {
			MyUser mUser=new MyUser();
			...
			file.upload(this, new UploadFileListener() {
				...
				public void onSuccess() {
					...
					currentUser.update(SetActivity.this, new UpdateListener() {
						...
						@Override
						public void onSuccess() {
							Toast.makeText(SetActivity.this, "更改成功", Toast.LENGTH_LONG).show();
						}
						@Override
						public void onFailure(int arg0, String arg1) {
							// TODO Auto-generated method stub
							Toast.makeText(SetActivity.this, "更改失败", Toast.LENGTH_LONG).show();	
						}
					});
				}
