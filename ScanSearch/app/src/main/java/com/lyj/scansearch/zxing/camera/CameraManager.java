...
package com.lyj.scansearch.zxing.camera;
...
public final class CameraManager {
    ...
    public static final int CODE_2D_SCAN = 0x00;
    public static final int CODE_BAR_SCAN = 0x01;

    private static CameraManager cameraManager;

    private static float width2ScreenScale=0.8f;//宽相对于屏幕的比例
    private static float heigh2WidthScale=0.9f;//高相对于宽的比例
    private static boolean framingRectChanged=false;
    ...
    private static Camera camera;//原来不是 静态属性
    ...
    public Rect getFramingRect() {
        if(framingRect==null||framingRectChanged){
            framingRectChanged=false;
            if (camera == null) {
                return null;
            }
            ...
            int width = (int) (metrics.widthPixels * 0.8);//width2ScreenScale
            //int height = (int) (width * 0.6);//width2ScreenScale
            int height = (int) (width * 1);//width2ScreenScale
    ...
    public static void setFlashLightOn(boolean onFlag) {
        if (camera == null) {
            return;
        }
    ...
    /**
     * 设置扫描窗口的比例
     * @param styleNum CameraManager 中的扫描窗口模式号
     */
    public static void setWidthAndHeighScale(int styleNum){
        switch (styleNum){
            case CODE_2D_SCAN:
                width2ScreenScale=0.8f;
                heigh2WidthScale=0.9f;
                break;
            case CODE_BAR_SCAN:
                width2ScreenScale=0.8f;
                heigh2WidthScale=0.6f;
                break;
            default:
                break;
        }
        framingRectChanged=true;
    }
}
